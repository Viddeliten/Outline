...
/*		This file was stolen from Shell on https://github.com/Viddeliten/shell/blob/master/functions/class_db.php
/********************************************/
class db_class
{
	public $insert_id;
...
if(!function_exists("mysql_query"))
{
	...
	function mysql_connect($db_server=NULL, $db_database=NULL, $db_username=NULL, $db_password=NULL)
	{
		...
		return static_db::getInstance($db_server, $db_database, $db_username, $db_password);
	}
	...
	{
		$db = new db_class();
		$str = mysqli_real_escape_string($db->connection, $str);
